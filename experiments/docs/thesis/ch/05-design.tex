...
\begin{enumerate}
  ...
  \item \textbf{Cost.} Pro's list price is $3.1\times$ Flash's.\footnote{DeepSeek
        ...
        deepseek-v4-pro \$0.435 / \$0.87.} On this project's own pilot
        tasks --- not a vendor-published figure --- Flash's outputs ran
        roughly $1.3\times$ longer, so the per-task ratio is near
        $2.4\times$, which over thousands of rollouts is the
