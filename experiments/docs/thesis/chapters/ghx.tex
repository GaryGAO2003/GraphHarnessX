...
aggregate score. None reports L1 or above. Given a recorded execution graph, L1 and L2 are
mechanical; L3 is where this thesis's evidence places the remaining effort
(\S\ref{sec:future}).
