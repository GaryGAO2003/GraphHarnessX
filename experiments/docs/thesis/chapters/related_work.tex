...
independent execution of another group's released loop, and this survey
did not identify an earlier external re-execution of the AEGIS release
...
claim: \textbf{within the surveyed corpus, no published work was identified
as closing provenance into an automated improvement loop.}
...
\textbf{Within the surveyed corpus, no identified system holds all of these
at once --- not that any one of them is new.}
