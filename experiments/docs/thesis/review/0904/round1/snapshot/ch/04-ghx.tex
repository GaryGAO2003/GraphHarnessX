...
\begin{figure}[t]
\centering
\resizebox{\textwidth}{!}{\input{fig/loop.tex}}
...
graph~\cite{agentflow} are adopted directly; its node vocabulary is
...
The cone is small. Over the graph campaign's early failed cohort ($n{=}33$,
