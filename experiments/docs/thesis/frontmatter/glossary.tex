...
mechanism grounds, to have worked; used as descriptive evidence of a large mechanism-confirmed event.
...
candidate edit, in four rungs: \textbf{R0} deployed, \textbf{R1} executed,
\textbf{R2} fired (and on what), \textbf{R3} changed outcomes. Distinct
from the GHX switch ladder, numbered L0--L5 in the run archives.
