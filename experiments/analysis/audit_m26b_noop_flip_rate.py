...
(config_hash is NOT used: it drifts even under noop 鈥?known quirk.)
"""
...
def main() -> int:
    ...
    try:
        ...
        require_path(RUN / "curves.json", "curves file")
        require_path(RUN / "data/task_history.jsonl", "task history")
