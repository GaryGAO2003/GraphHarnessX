...
BATCHES = [("w3", D5, "_w3"), ("cov", D6, "_cov"), ("transfer", D6, "_transfer"),
           ("canary", D6, "_canary"), ("proof1", D6, "_proof1"), ("proof2", D6, "_proof2")]
...
for k in (3, 5, 10):
    ...
    if have:
        print(f"non-canary mean pass@1 {sum(r[3] for r in have)/len(have):.3f}  "
