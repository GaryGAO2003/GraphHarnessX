...
# Revival coverage moved to test_rejected_revivals.py. The two tests that lived
# here pinned the retired briefs layout (R<n>/briefs/B-R<n>-NN.md with
# lead_pointer: archive:<cid>), which the corpus has zero instances of, so they
# were asserting that a dead scan scanned correctly (P-23).
